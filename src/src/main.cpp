...
int main(int argc, const char **argv) {
  /* use A star algorithm to find the shortest path from user inputted
     starting and ending locations. The program will plot and render the found
     path.

     params:
     - arg[0]: optional. user specified map file. If none is provided, it will
     use a default map.
  */
  ...
  std::cout << "Please provide start_x, start_y, end_x, end_y: ";
